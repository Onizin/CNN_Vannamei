...
def test_conv2d_with_batch(batch_tensor, image_paths):
    ...
    for i, (image_path, prediction) in enumerate(zip(image_paths, predictions)):
        ...
        base_filename = os.path.splitext(os.path.basename(image_path))[0]
        prediction_file = os.path.join("c:\\CNN_Vannamei\\detection_results", f"{base_filename}_prediction.txt")
        ...
        output_image_path = os.path.join("c:\\CNN_Vannamei\\detection_results", 
    ...
    summary_file = os.path.join("c:\\CNN_Vannamei\\detection_results", "detection_summary.txt")
...
def main():
    directory_path = "c:\\CNN_Vannamei\\data\\setlist"
    output_path = "c:\\CNN_Vannamei\\detection_results"
